...
@Autonomous
public class auto_ig_4discuri extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        servoBlock.setServoPositions(0.69);
        ...
        Trajectory trajShoot = bot.trajectoryBuilder(new Pose2d())
                ...
                .splineTo(new Vector2d(63.5, 0), Math.toRadians(-20))
                .build();


        Trajectory goToRings = bot.trajectoryBuilder(trajShoot.end().plus(new Pose2d(0,0,Math.toRadians(20))), false)
